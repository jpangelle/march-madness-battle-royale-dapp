...
export function handleAdminRoleGranted(event: AdminRoleGranted): void {
  ...
  // - contract.day(...)
  // - contract.eliminatedTeams(...)
  // - contract.getAllowance(...)
  // - contract.getEliminatedTeams(...)
  // - contract.getPoolEntries(...)
  // - contract.getPoolEntryPicks(...)
  // - contract.getRoleAdmin(...)
  // - contract.hasRole(...)
  // - contract.isEntryEliminated(...)
  // - contract.isRegistrationOpen(...)
  // - contract.poolEntries(...)
  // - contract.poolEntryAddresses(...)
